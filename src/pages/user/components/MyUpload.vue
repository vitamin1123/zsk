<template>
  <t-space direction="vertical">
    ...
    <dialog-form1 v-model:visible="formDialogVisible1" :data="formData1" @submit-success="ggM" />
    <t-table
    ...
    >
      <template #operation="{ row }">
        ...
        <t-link hover="color" theme="primary" @click="rehandleClickOp1(row)">
          {{ '分享' }}
        </t-link>
      </template>
    </t-table>
...
import DialogForm1 from './DialogForm1.vue';
...
const formDialogVisible1 = ref(false);
const formData = ref(null);
const formData1 = ref(null);
const columns = [
...
const rehandleClickOp1 = (context: TableRowData) => {
  console.log(context.name);
  formData1.value = {
    name: context.name,
  };
  formDialogVisible1.value = true;
};
</script>
